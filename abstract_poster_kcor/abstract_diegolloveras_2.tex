...
\author{D.G. Lloveras\inst{1}, A.M. Vásquez\inst{1}, E. Landi\inst{2}, R.A. Frazin\inst{2}}
...
La distribución tridimensional de la densidad electrónica de la corona solar baja puede determinarse mediante técnicas tomográficas. Utilizando observaciones en luz blanca la determinación tomográfica de la densidad es absoluta. Por el contrario, utilizando imágenes en extremo ultravioleta, la misma depende de la abundancia coronal de hierro $a$ y del denominado \emph{factor de irregularidad} coronal $f \equiv \left< N_e^2 \right> /  \left< N_e \right>^2$, dónde $\left<\right>$ indica promedio sobre la distribución térmica en cada celda tomográfica. Aplicamos ambas metodologías en forma sistemática para varias rotaciones solares seleccionadas. Comparando los resultados de ambas técnicas en forma estadística, estudiamos los valores posibles de $f$ y $a$ en la baja corona. Comparamos nuestros resultados con otros estudios y discutimos sus implicancias.
}
