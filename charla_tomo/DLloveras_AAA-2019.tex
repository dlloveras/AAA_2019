...
\begin{itemize}
 \item La baja corona es ópticamente delgada y emite eficientemente en el rango EUV y WL.\\
...
\end{center}
%\tiny
$\azul{E_{b} }  =  \azul{\int \mathrm{d}T \  R_b(T)  \rojo{{\sf LDEM}(T)} }$ $\rightarrow$
...
\begin{center}
Magnetograma
\includegraphics[width=0.75\textwidth,height=0.42\textheight]{new_figs/2208_magnetograma_adaptivo.png}
\end{center}
\column{0.4\textwidth}
\begin{center}
Extrapolación Magnética
\includegraphics[width=0.75\textwidth]{new_figs/CR2081.jpg}
\end{center}
\end{columns}
\begin{columns}
\column{0.7\textwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{new_figs/Rpoint-map_5colores_fulleuvi_base.pdf}\\
\end{center}
\column{0.3\textwidth}
Ajustes del trazado \\
$\rightarrow$ Ne $\sim$ exponencial \\
$\rightarrow$ Te $\sim$ lineal 
\end{columns}
}
%---------------------------------------------------------------------------------------
...
\titulo{Comparación en estructuras magnéticas}
\begin{center}
\includegraphics[width=0.47\textwidth]{new_figs/2208_ne_1055_streamer.eps}
\includegraphics[width=0.47\textwidth]{new_figs/2208_ne_1055_CH.eps}\\
\includegraphics[width=0.47\textwidth]{new_figs/2208_lambda_n_streamer.eps}
\includegraphics[width=0.47\textwidth]{new_figs/2208_lambda_n_CH.eps}\\
\includegraphics[width=0.47\textwidth]{new_figs/2208_temp_media_streamer.eps}
\includegraphics[width=0.47\textwidth]{new_figs/2208_temp_media_CH.eps}\\
\end{center}
}
%--------------------------------------------------------------------------------
...
\footnotesize
\begin{itemize}
\item La técnica tomográfica es la única herramienta global existente para validación de la baja corona.
