...
\end{center}
%\tiny
$\azul{E_{k} }  =  \azul{\int \mathrm{d}T \  R_k(T)  \rojo{{\sf LDEM}(T)} }$ $\rightarrow$
...
\end{center}
(Lloveras et al. 2017) $\rightarrow$ Incertezas sistemáticas en DEMT $\sim 10 \%$
}
%---------------------------------
\begin{comment}
\frame{
...
%----------------------------------
\frame{
\titulo{Validación del módulo AWSoM del modelo Space weather modeling framework}
\begin{itemize}
  \item WHI
  \item Jin et al. 2012, Revista
  \item Rona et al. 2015,Revista
  \item Van del Holst 2014, Revista
  \item Colage XI presentamos una comparacion del minimo del 2009 y guiamos la validación de la parte baja del modelo
  \item Sachdeva 2019, APJ.
\end{itemize}
...
\frame{
\vspace{-0.15cm}
\titulo{Comparación 3D MHD/Tomografía}
\footnotesize
\vspace{-0.25cm}
%\begin{center}
...
\begin{center}
\includegraphics[width=0.85\textwidth,height=2.cm]{new_figs/ne_demt_2208_1055.png}
\includegraphics[width=0.85\textwidth,height=2.cm]{new_figs/ne_awsom_2208_1055.png}
\includegraphics[width=0.85\textwidth,height=2.cm]{new_figs/ne_diff_2208_1055.png}
\end{center}
\column{0.45\textwidth}
\begin{center}
\includegraphics[width=0.85\textwidth,height=2.cm]{new_figs/te_demt_2208_1055.png}
...
\vspace{-0.25cm}
\begin{center}
\includegraphics[width=0.35\textwidth]{new_figs/Median_Ne_2208_v2.eps}
\includegraphics[width=0.35\textwidth]{new_figs/Median_Te_2082_v2.eps}\\
\end{center}
...
\frame{ 
\titulo{Trazado a lo largo de líneas magnéticas}
%\vspace{-0.05cm}
%\titulo{a}
\footnotesize
\begin{center}
%\includegraphics[width=0.35\textwidth]{new_figs/Median_Ne_2082.eps}
%\includegraphics[width=0.35\textwidth]{new_figs/Median_Tm_2082.eps}\\
%\includegraphics[width=0.35\textwidth]{new_figs/Median_Ne_2208.eps}
%\includegraphics[width=0.35\textwidth]{new_figs/Median_Tm_2208.eps}\\
\includegraphics[width=0.55\textwidth]{new_figs/2208_magnetograma_adaptivo.png}
\includegraphics[width=0.35\textwidth]{new_figs/CR2081.jpg}
...
\titulo{Comparación MHD/DEMT en estructuras magnéticas}
\begin{center}
\includegraphics[width=0.45\textwidth]{new_figs/2082_ne_1055.eps}
\includegraphics[width=0.45\textwidth]{new_figs/2208_ne_1055.eps}\\
\includegraphics[width=0.45\textwidth]{new_figs/2082_lambda_n.eps}
\includegraphics[width=0.45\textwidth]{new_figs/2208_lambda_n.eps}\\
\includegraphics[width=0.45\textwidth]{new_figs/2082_temp_media.eps}
\includegraphics[width=0.45\textwidth]{new_figs/2208_temp_media.eps}\\
\end{center}
}
%--------------------------------------------------------------------------------
...
\frame{
\vspace{-0.05cm}
\titulo{Comentarios finales}
\footnotesize
\begin{itemize}
\item La técnica tomográfia es la única herramienta global existente para validacion de la baja corona.
